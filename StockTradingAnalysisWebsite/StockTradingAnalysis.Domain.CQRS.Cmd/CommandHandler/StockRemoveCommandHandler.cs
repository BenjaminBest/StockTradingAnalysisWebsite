...
{
    public class StockRemoveCommandHandler : ICommandHandler<StockRemoveCommand>
    {
        ...
        public StockRemoveCommandHandler(IAggregateRepository<StockAggregate> repository)
        {
        ...
        public void Execute(StockRemoveCommand command)
        {
