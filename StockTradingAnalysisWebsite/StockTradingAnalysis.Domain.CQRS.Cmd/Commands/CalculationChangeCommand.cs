...
{
    public class CalculationChangeCommand : Command
    {
        /// <summary>
        /// Gets/sets the name
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculationChangeCommand"/> class.
        /// </summary>
        ...
        public CalculationChangeCommand(Guid id, int version, string name, string wkn, decimal multiplier,
