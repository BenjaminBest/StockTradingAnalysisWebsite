...
namespace StockTradingAnalysis.Web.AutoMapperProfiles
{
	...
	public class TransactionProfile : Profile
	{
		...
		{
			CreateMap<ITransaction, TransactionViewModel>()
			...
			CreateMap<IBuyingTransaction, TransactionBuyingViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
			...
			CreateMap<ISellingTransaction, TransactionSellingViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
				.ForMember(t => t.OriginalVersion, source => source.MapFrom(s => s.OriginalVersion))
				.ForMember(t => t.OrderDate, source => source.MapFrom(s => s.OrderDate))
				.ForMember(t => t.Units, source => source.MapFrom(s => s.Shares))
			...
			CreateMap<IDividendTransaction, TransactionDividendViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
				.ForMember(t => t.OriginalVersion, source => source.MapFrom(s => s.OriginalVersion))
				.ForMember(t => t.OrderDate, source => source.MapFrom(s => s.OrderDate))
				.ForMember(t => t.Units, source => source.MapFrom(s => s.Shares))
			...
			CreateMap<ITransactionPerformance, TransactionPerformanceViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
			...
			CreateMap<ITransaction, TransactionIndexViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
				.ForMember(t => t.OrderDate, source => source.MapFrom(s => s.OrderDate))
				.ForMember(t => t.Units, source => source.MapFrom(s => s.Shares))
				.ForMember(t => t.PricePerUnit, source => source.MapFrom(s => s.PricePerShare))
			...
			CreateMap<ISplitTransaction, TransactionSplitViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
				.ForMember(t => t.OriginalVersion, source => source.MapFrom(s => s.OriginalVersion))
				.ForMember(t => t.OrderDate, source => source.MapFrom(s => s.OrderDate))
				.ForMember(t => t.Units, source => source.MapFrom(s => s.Shares))
			...
			CreateMap<ITransaction, TransactionHistoryViewModel>()
				.ForMember(t => t.Id, source => source.MapFrom(s => s.Id))
				.ForMember(t => t.OrderDate, source => source.MapFrom(s => s.OrderDate))
				.ForMember(t => t.Units, source => source.MapFrom(s => s.Shares))
				.ForMember(t => t.PricePerUnit, source => source.MapFrom(s => s.PricePerShare))
