...
namespace StockTradingAnalysis.Web.Common.Formatting.StatisticConverters
{
    ...
    public class AmountOfProfitTradesToCardConverter : IStatisticCardConverter
    {
        /// <summary>
        /// Gets the order.
        /// </summary>
        ...
        public CardViewModel Convert(IStatistic statistic)
        {
            return new CardViewModel
            {
                ...
                Header = Resources.ViewTextKpiAmountOfProfitTrades,
                Title = $"{statistic.AmountOfProfitTransactions} ({statistic.PercentageOfProfitTransactions} %)"
            };
        }
    }
}