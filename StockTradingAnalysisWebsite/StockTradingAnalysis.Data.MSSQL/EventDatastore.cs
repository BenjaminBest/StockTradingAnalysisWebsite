...
namespace StockTradingAnalysis.Data.MSSQL
{
    ...
    public class EventDatastore : DatastoreBase, IEventDatastore
    {
        ...
        public EventDatastore(string connectionName, string tableName, IPerformanceMeasurementService performanceMeasurementService, IConfigurationRegistry configurationRegistry)
