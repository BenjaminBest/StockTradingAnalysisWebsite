...
{
    public class CalculationInitialTpChangedEventHandler : IEventHandler<CalculationInitialTpChangedEvent>
    {
        ...
        public CalculationInitialTpChangedEventHandler(IModelRepository<ICalculation> modelRepository)
        {
        ...
        public void Handle(CalculationInitialTpChangedEvent eventData)
        {
            ...
            ((Calculation) item).InitialTp = eventData.InitialTp;
