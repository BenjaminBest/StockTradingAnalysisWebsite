...
{
    public class StockNameChangedEventHandler : IEventHandler<StockNameChangedEvent>
    {
        ...
        public StockNameChangedEventHandler(IModelRepository<IStock> modelRepository)
        {
        ...
        public void Handle(StockNameChangedEvent eventData)
        {
            ...
            ((Stock) item).Name = eventData.Name;
