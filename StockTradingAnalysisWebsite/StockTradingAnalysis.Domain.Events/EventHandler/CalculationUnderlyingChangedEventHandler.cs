...
{
    public class CalculationUnderlyingChangedEventHandler : IEventHandler<CalculationUnderlyingChangedEvent>
    {
        ...
        public CalculationUnderlyingChangedEventHandler(IModelRepository<ICalculation> modelRepository)
        {
        ...
        public void Handle(CalculationUnderlyingChangedEvent eventData)
        {
            ...
            ((Calculation) item).Underlying = eventData.Underlying;
