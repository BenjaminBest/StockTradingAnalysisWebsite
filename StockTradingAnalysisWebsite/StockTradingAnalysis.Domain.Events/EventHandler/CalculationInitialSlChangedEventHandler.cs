...
{
    public class CalculationInitialSlChangedEventHandler : IEventHandler<CalculationInitialSlChangedEvent>
    {
        ...
        public CalculationInitialSlChangedEventHandler(IModelRepository<ICalculation> modelRepository)
        {
        ...
        public void Handle(CalculationInitialSlChangedEvent eventData)
        {
            ...
            ((Calculation) item).InitialSl = eventData.InitialSl;
