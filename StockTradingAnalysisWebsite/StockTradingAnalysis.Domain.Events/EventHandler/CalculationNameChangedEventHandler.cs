...
{
    public class CalculationNameChangedEventHandler : IEventHandler<CalculationNameChangedEvent>
    {
        ...
        public CalculationNameChangedEventHandler(IModelRepository<ICalculation> modelRepository)
        {
        ...
        public void Handle(CalculationNameChangedEvent eventData)
        {
            ...
            ((Calculation) item).Name = eventData.Name;
