...
{
    public class CalculationMultiplierChangedEventHandler : IEventHandler<CalculationMultiplierChangedEvent>
    {
        ...
        public CalculationMultiplierChangedEventHandler(IModelRepository<ICalculation> modelRepository)
        {
        ...
        public void Handle(CalculationMultiplierChangedEvent eventData)
        {
            ...
            ((Calculation) item).Multiplier = eventData.Multiplier;
