...
{
    public class CalculationAddedEvent : DomainEvent
    {
        /// <summary>
        /// Gets/sets the name
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculationAddedEvent"/> class.
        /// </summary>
        ...
        public CalculationAddedEvent(Guid id, Type aggregateType, string name, string wkn, decimal multiplier,
        ...
        /// Initializes a new instance of the <see cref="CalculationAddedEvent"/> class.
        /// </summary>
        protected CalculationAddedEvent()
        {
