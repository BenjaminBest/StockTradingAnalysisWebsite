...
namespace StockTradingAnalysis.Web.Common.Formatting.StatisticConverters
{
    ...
    public class AmountOfTransactionsPerMonthToCardConverter : IStatisticCardConverter
    {
        /// <summary>
        /// Gets the order.
        /// </summary>
        ...
        public CardViewModel Convert(IStatistic statistic)
        {
            return new CardViewModel
            {
                ...
                Header = Resources.ViewTextKpiAmountOfTransactionsPerMonth,
                Title = statistic.AmountOfTransactionsPerMonth.ToString("0.00")
            };
        }
    }
}