...
namespace StockTradingAnalysis.Web.Common.Formatting.StatisticConverters
{
    ...
    public class MostConsecutiveLossesToCardConverter : IStatisticCardConverter
    {
        /// <summary>
        /// Gets the order.
        /// </summary>
        ...
        public CardViewModel Convert(IStatistic statistic)
        {
            return new CardViewModel
            {
                ...
                Header = Resources.ViewTextKpiMostConsecutiveLosses,
                Title = statistic.MostConsecutiveLosses.ToString()
            };
        }
    }
}