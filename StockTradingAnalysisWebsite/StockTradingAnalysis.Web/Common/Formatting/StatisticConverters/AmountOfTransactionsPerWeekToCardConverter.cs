...
namespace StockTradingAnalysis.Web.Common.Formatting.StatisticConverters
{
    ...
    public class AmountOfTransactionsPerWeekToCardConverter : IStatisticCardConverter
    {
        /// <summary>
        /// Gets the order.
        /// </summary>
        ...
        public CardViewModel Convert(IStatistic statistic)
        {
            return new CardViewModel
            {
                ...
                Header = Resources.ViewTextKpiAmountOfTransactionsPerWeek,
                Title = statistic.AmountOfTransactionsPerWeek.ToString("0.00")
            };
        }
    }
}