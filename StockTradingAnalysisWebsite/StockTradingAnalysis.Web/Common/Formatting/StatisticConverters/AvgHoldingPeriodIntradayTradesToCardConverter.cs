...
namespace StockTradingAnalysis.Web.Common.Formatting.StatisticConverters
{
    ...
    public class AvgHoldingPeriodIntradayTradesToCardConverter : IStatisticCardConverter
    {
        /// <summary>
        /// Gets the order.
        /// </summary>
        ...
        public CardViewModel Convert(IStatistic statistic)
        {
            return new CardViewModel
            {
                ...
                Title = $"{statistic.AvgHoldingPeriodIntradayTrades:0.00} {Resources.DisplayTooltipMinutes} ({statistic.AmountIntradayTrades})"
            };
        }
    }
}