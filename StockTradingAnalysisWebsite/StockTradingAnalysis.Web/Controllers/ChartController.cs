...
namespace StockTradingAnalysis.Web.Controllers
{
	...
	public class ChartController : Controller
	{
		...
		[HttpGet]
		public IActionResult CandlestickChartQuoteDataByStockId(Guid id)
		{
		...
		[HttpGet]
		public IActionResult CandlestickChartTransactionDataByStockId(Guid id)
		{
		...
		[HttpGet]
		public IActionResult CandlestickChartAverageBuyingPriceByStockId(Guid id)
		{
