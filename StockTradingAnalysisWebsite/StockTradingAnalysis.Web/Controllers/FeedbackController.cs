...
namespace StockTradingAnalysis.Web.Controllers
{
	public class FeedbackController : Controller
	{
		...
		[HttpPost]
		public IActionResult Edit(Guid id, FeedbackViewModel model)
		{
			try
			{
		...
		[HttpPost]
		public IActionResult Delete(Guid id, FeedbackViewModel model)
		{
			try
			{
		...
		/// <returns></returns>
		public IActionResult GetFeedbackName(string term)
		{
