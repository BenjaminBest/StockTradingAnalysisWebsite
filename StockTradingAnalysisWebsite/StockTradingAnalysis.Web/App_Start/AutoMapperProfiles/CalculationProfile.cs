...
namespace StockTradingAnalysis.Web.AutoMapperProfiles
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="CalculationProfile"/> class.
		/// </summary>
		public CalculationProfile()
		{
			CreateMap<ICalculation, CalculationViewModel>()
			...
			CreateMap<ICalculationQuotation, CalculationQuotationViewModel>()
			...
			CreateMap<ICalculationResult, CalculationResultViewModel>()
				.ForMember(t => t.Wkn, source => source.MapFrom(s => s.Wkn))
