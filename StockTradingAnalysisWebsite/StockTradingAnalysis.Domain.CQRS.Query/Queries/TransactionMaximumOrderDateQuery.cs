...
{
    /// <summary>
    /// The TransactionMaximumOrderDateQuery is used to return the order date of the newest transaction.
    /// </summary>
    /// <seealso cref="Interfaces.Queries.IQuery{DateTime}" />
    public class TransactionMaximumOrderDateQuery : IQuery<DateTime>
    {
        /// <summary>
        /// The filters
        /// </summary>
        ...
        /// <returns></returns>
        public TransactionMaximumOrderDateQuery Register<T>(T filter) where T : ITransactionFilter
        {
            _filters.Add(filter);
