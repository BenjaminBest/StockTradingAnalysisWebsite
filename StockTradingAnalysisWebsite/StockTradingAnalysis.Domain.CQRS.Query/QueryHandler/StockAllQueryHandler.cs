...
{
    public class StockAllQueryHandler : IQueryHandler<StockAllQuery, IEnumerable<IStock>>
    {
        ...
        public StockAllQueryHandler(IModelReaderRepository<IStock> modelReaderRepository)
        {
